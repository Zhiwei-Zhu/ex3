 ...
 */
final class Version20200312094843 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD matiere_id INT NOT NULL, DROP create_at');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD create_at DATETIME NOT NULL, DROP matiere_id');
    }
}
